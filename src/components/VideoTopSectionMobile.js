...
import posterOpeningLoopVideoMobile from "../assets/video/poster-opening-loop-video-mobile.mp4"
import posterOpeningVideoMobile from "../assets/video/poster-opening-video-mobile.mp4"
...
const StyledImage = styled.div`
  ...
  svg:hover {
    opacity: 1;
    filter: blur(1px) drop-shadow(0 0 1em var(--gold));
  }
  svg:hover path {
    stroke: var(--gold);
    /* filter: blur(1px); */
  ...
  <>
    {noControls ? (
      ...
      >
                      ...
                      {!videoFailed ? (
                        <>
                          <video
                            ...
                            src={
                              isMobilePortrait
                                ? posterOpeningVideoMobile
                                : posterOpeningVideo
                            }
                            className="parallax-video posterOverlayOpening"
                            onEnded={() => {
                              const posterLoop = isBrowser
                                ? document.getElementsByClassName(
                                    "posterOverlayOpening"
                                  )
                                : ""
                              posterLoop[0].style.visibility = "hidden"
                            }}
                          />
                          <video
                            ...
                            src={
                              isMobilePortrait
                                ? posterOpeningLoopVideoMobile
                                : posterOpeningLoopVideo
                            }
                        ...
                        <StaticImage
                          className="parallax-video posterOverlayOpening"
                          src="../assets/images/poster-loop-mobile.png"
                          // src="../assets/images/video_poster_fallback_mobile.png"
                          // src={isMobilePortrait ? "../assets/images/poster-loop-mobile.png" : "../assets/images/poster-loop-desktop.png"}
                          placeholder="none"
                          alt="man looking at the horizon over the ocean"
                        />
                        :
                        <StaticImage
                          className="parallax-video posterOverlayOpening"
                          src="../assets/images/poster-loop-desktop.png"
                          // src="../assets/images/video_poster_fallback_mobile.png"
                          // src={isMobilePortrait ? "../assets/images/poster-loop-mobile.png" : "../assets/images/poster-loop-desktop.png"}
                          placeholder="none"
                          alt="man looking at the horizon over the ocean"
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <feBlend
                            ...
                            result="effect1_dropShadow_8695_13801"
                          />
                          <feBlend
                            mode="normal"
                            in="SourceGraphic"
                            in2="effect1_dropShadow_8695_13801"
                            result="shape"
                          />
                        </filter>
                      </defs>
        ...
        <StyledCloseIcon>
          <div className="close" onClick={handleVideoEnd}></div>
        </StyledCloseIcon>
        <VideoStyledBanner>
...
export default function VideoTopSection({
  ...
  const topSection = isBrowser
    ? document.getElementsByClassName("top-section")
    : ""

  const closeIcon = isBrowser ? document.getElementsByClassName("close") : ""
  const initialVideo = isBrowser
  ...
  //state toggled when video fails to play. Triggers conditional render of a static asset in the parallax component
  useEffect(() => {
  ...
  const handlePlay = () => {
    ...
    topSection[0].style.display = "none"
