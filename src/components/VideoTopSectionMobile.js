                    ...
                    <>
                      {!videoFailed ? (
                        ...
                        <video
                          ...
                          muted
                          playsInline
                          src={posterOpeningVideoMobile}
                          className="parallax-video posterOverlayOpening"
                          onEnded={() => {
                            const posterLoop = isBrowser ? document.getElementsByClassName("posterOverlayOpening") : "";
                        ...
                        <video
                          ...
                          muted
                          playsInline
                          src={posterOpeningLoopVideoMobile}
        ...
        <StyledSection>
          <motion.div>
            ...
            >
              ...
              transition={{ duration: .8, delay: 4.2}}
                  style={{
                    opacity: "0"
                  }}
