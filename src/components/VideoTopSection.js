                  ...
                  children: (
                    <>
                      {!videoFailed ? (
                        ...
                        //Girish: The two static components below are meant to follow your class naming convention. You might want to check if I missed something important. They are meant to appear on mobile if the videoFailed to play, which only happens on an Iphone in a low power mode
                        <StaticImage
                          className="parallax-video posterOverlayOpening"
                          src="../assets/images/video_poster_fallback.png"
                          placeholder="none"
